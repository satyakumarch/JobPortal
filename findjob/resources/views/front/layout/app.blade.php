...
<script src="{{ assets('assets/js/bootstrap.bundle.5.1.3.min.js') }}"></script>
<script src="{{ assets('assets/js/instantpages.5.1.0.min.js') }}"></script>
<script src="{{ assets('assets/js/lazyload.17.6.0.min.js') }}"></script>
